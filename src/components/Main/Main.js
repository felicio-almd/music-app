...
const Main = ( {results} ) => {  
  ...
  return (
    ...
    <div>    
        <div className={`playlist-container ${showArtists ? 'hide-playlist' : ''}`}>
        <div id="result-playlists" className='results-p'>
    ...
    <div id="result-artist" className={`grid-container ${showArtists ? 'show-artists' : ''}`}>
